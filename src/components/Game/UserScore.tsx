...
const UserScore = ({ user }: { user: "RED" | "YELLOW" }) => {
  ...
  return (
    <div
      ...
      className="bg-white relative flex-center flex-col font-bold text-center border-black border-[3px] rounded-[20px] max-w-[140px] pb-4 pt-[46px] shadow-container flex-1 laptop:max-w-full laptop:flex-row laptop:gap-10 laptop:py-[15px] tablet:flex-row tablet:max-w-full tablet:gap-10 tablet:py-[15px] mobile:max-w-full mobile:py-[10px] mini:max-w-full mini:py-[10px]  mini:scale-90"
    >
      <div
