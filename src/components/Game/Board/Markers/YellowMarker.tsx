...
const YellowMarker = ({ win }: { win: boolean }) => {
  return (
    <div className="relative">
      {win && (
        <div className="w-[34px] h-[34px] absolute bg-transparent top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 rounded-full border-white border-[6px] mobile:w-5 mobile:h-5 mini:w-5 mini:h-5"></div>
      )}
      <BigYellowMarker
